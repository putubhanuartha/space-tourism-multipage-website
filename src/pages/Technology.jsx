      ...
      <div className="container mx-auto p-4 mt-8 lg:mt-4 md:p-8">
        ...
        <div className="mt-8 lg:mt-4 flex flex-col items-center lg:flex-row-reverse lg:justify-around lg:items-start xl:items-center">
          <img
            ...
            className="rounded-sm opacity-100 transition-opacity duration-150 md:w-[50%] md:h-auto md:object-cover"
          />
          <div className="lg:px-8 xl:px-0">
            <nav className="w-full mt-12 lg:mt-9">
              <ul className="flex w-[75%] max-w-sm justify-evenly mx-auto">
                {techData.map((el, i) => {
                  return (
                    <li>
                      <button
                        ...
                        className="text-white font-bellefair text-2xl border-2 border-white w-11 h-11 rounded-full hover:bg-white hover:text-black transition-colors duration-200"
                      >
                        {i + 1}
                      </button>
                    </li>
